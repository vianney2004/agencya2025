...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <form action="/InicioDeSesion2/fpdf/PruebaV.php" method="post" accept-charset="utf-8">
              <div class="row">
                <div class="col">
  ...
  $("#filtro").on("click", function(e){ 
    ...
    if(f_ingreso !="" && f_fin !=""){
      $.post("filtro.php", {f_ingreso: f_ingreso, f_fin: f_fin}, function (data) {
        $("#tableEmpleados").hide();
