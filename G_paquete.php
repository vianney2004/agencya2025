...
<head>
    ...
    <title>Reporte Paquetes Viaje</title>
      ...
      <div class="contenedor_header">
          <ul class="flex-container">
            ...
            <li class="flex-item">
              <p>
                <strong>
                Paquetes Viaje - Agencia de Viajes
                </strong>
              </p>
            </li>
            <li class="flex-item"></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <form action="/InicioDeSesion2/fpdf/PruebaV2.php" method="post" accept-charset="utf-8">
              <div class="row">
                <div class="col">
...
$("#filtro").on("click", function(e){ 
    ...
    if(f_ingreso !="" && f_fin !=""){
        $.post("filtro2.php", {f_ingreso: f_ingreso, f_fin: f_fin}, function (data) {
            $("#tablePaquetes").hide();
