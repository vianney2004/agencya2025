...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <form action="/InicioDeSesion2/fpdf/PruebaV4.php" method="post" accept-charset="utf-8">
              <div class="row">
                <div class="col">
  ...
  $(function() {
      ...
      $("#filtrarReservas").on("click", function(e){ 
        e.preventDefault();
        ...
        if(f_inicio !="" && f_fin !=""){
          $.post("filtro4.php", {f_inicio: f_inicio, f_fin: f_fin}, function (data) {
            $(".resultadoFiltrarReservas").html(data);
            loaderReservas(false);
          });  
        }else{
          $("#loaderReservas").html('<p style="color:red; font-weight:bold;">Debe seleccionar ambas fechas</p>');
        }
      });

      function loaderReservas(statusLoader){
        console.log(statusLoader);
        if(statusLoader){
          $("#loaderReservas").show();
          $("#loaderReservas").html('<img class="img-fluid" src="assets/img/cargando.svg" style="left:50%; right: 50%; width:50px;">');
        }else{
          $("#loaderReservas").hide();
        }
      }
