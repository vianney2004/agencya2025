...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <form action="/InicioDeSesion2/fpdf/PruebaV5.php" method="post" accept-charset="utf-8">
              <div class="row">
                <div class="col">
  ...
  $(function() {
      ...
      $("#filtrarPagos").on("click", function(e){ 
        e.preventDefault();
        ...
        if(f_inicio !="" && f_fin !=""){
          $.post("filtro5.php", {f_inicio: f_inicio, f_fin: f_fin}, function (data) {
            $(".resultadoFiltrarPagos").html(data);
            loaderPagos(false);
          });  
        }else{
          $("#loaderPagos").html('<p style="color:red; font-weight:bold;">Debe seleccionar ambas fechas</p>');
        }
      });

      function loaderPagos(statusLoader){
        console.log(statusLoader);
        if(statusLoader){
          $("#loaderPagos").show();
          $("#loaderPagos").html('<img class="img-fluid" src="assets/img/cargando.svg" style="left:50%; right: 50%; width:50px;">');
        }else{
          $("#loaderPagos").hide();
        }
      }
